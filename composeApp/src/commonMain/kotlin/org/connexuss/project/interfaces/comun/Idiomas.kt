...
val ingles = Idioma(
    ...
    "recordar_email" to "Remember email",
    "debug_zona_pruebas" to "Debug: Go to the testing area",
    "introduce_correo" to "Enter your email",
    "correo_restablece_contrasennia" to "An email has been sent to reset your password. Check your inbox.",
    "error_enviando_correo" to "Error sending email",
    "info_restablecer_contrasennia" to "Once you reset your password from the browser, return to this app and log in with your new password.",
    "formato_correo_invalido" to "Invalid email format",
    "error_registrar" to "Error registering",
    "correo_aun_no_verificado" to "❗ Your email is not verified yet.",
    "correo_reenviado" to "Email resent successfully",
    "falta_info_correo_reenviado" to "❌ Missing information to resend the email",
    "error_reenviar" to "❌ Error resending.",
    "cargando" to "(loading...)",
    "imagen" to "Image",
    "enviar_mensaje" to "Send Message",
    "grupo" to "Group",
    "item_editar" to "Edit",
    "item_eliminar" to "Delete",
    "participantes_grupo" to "Group Participants",
    "editar_mensaje" to "Edit message",
    "nuevo_contenido" to "New content",
    "error_leer_mensaje" to "Error reading message",
    "crear" to "Create",
    "tema_creado_correcto" to "Topic created successfully",
    "error_crear_tema" to "Error creating topic",
    "buscar" to "Search...",
    "nuevo_tema" to "New Topic",
    "mas_crea_temas" to "Press + to create a new topic",
    "no_temas_encontrados" to "No topics found",
    "nombre_tema" to "Topic name",
    "cargando_tema" to "(loading topic...)",
    "hilo_no_encontrado" to "Thread not found",
    "clave_no_disponible" to "(key not available)",
    "clave_tema_no_disponible" to "(key or topic not available)",
    "nuevo_hilo" to "New Thread",
    "titulo_nuevo_hilo" to "Thread Title",
    "tema_no_encontrado" to "Topic not found",
    "usuario_no_encontrado" to "User not found",
    "eliminar_contacto" to "Delete Contact",
    "bloquear_usuario" to "Block User",
    "zona_pruebas" to "Testing Area",
    "debug_textos_realtime" to "Debug: Go to Realtime texts testing",
    "debug_pruebas_supabase" to "Debug: Go to Supabase tests",
    "debug_pruebas_encriptacion" to "Debug: Go to encryption tests",
    "debug_pruebas_persistencia" to "Debug: Go to data persistence tests",
    "admin_zona_reportes" to "ADMIN: Go to the reports area",
    "bloqueado" to "Blocked",
    "introduce_alias_privado_usuario" to "Enter the user's private alias:",
    "crear_nuevo_chat" to "Create New Chat",
    "selecciona_participantes" to "Select participants:",
    "nombre_del_grupo" to "Group name",
...
val portugues = Idioma(
    palabras = mapOf(
        ...
        "mantener_sesion" to "Manter sessão",
        "recordar_email" to "Lembrar e-mail",
        "debug_zona_pruebas" to "Debug: Ir para a área de testes",
        "introduce_correo" to "Insira seu e-mail",
        "correo_restablece_contrasennia" to "Um e-mail foi enviado para redefinir sua senha. Verifique sua caixa de entrada.",
        "error_enviando_correo" to "Erro ao enviar o e-mail",
        "info_restablecer_contrasennia" to "Depois de redefinir sua senha no navegador, volte para este aplicativo e entre com sua nova senha.",
        "formato_correo_invalido" to "Formato de e-mail inválido",
        "error_registrar" to "Erro ao registrar",
        "correo_aun_no_verificado" to "❗ Seu e-mail ainda não está verificado.",
        "correo_reenviado" to "E-mail reenviado com sucesso",
        "falta_info_correo_reenviado" to "❌ Faltam informações para reenviar o e-mail",
        "error_reenviar" to "❌ Erro ao reenviar.",
        "cargando" to "(carregando...)",
        "imagen" to "Imagem",
        "enviar_mensaje" to "Enviar mensagem",
        "grupo" to "Grupo",
        "item_editar" to "Editar",
        "item_eliminar" to "Excluir",
        "participantes_grupo" to "Participantes do grupo",
        "editar_mensaje" to "Editar mensagem",
        "nuevo_contenido" to "Novo conteúdo",
        "error_leer_mensaje" to "Erro ao ler a mensagem",
        "crear" to "Criar",
        "tema_creado_correcto" to "Tópico criado com sucesso",
        "error_crear_tema" to "Erro ao criar o tópico",
        "buscar" to "Buscar...",
        "nuevo_tema" to "Novo tópico",
        "mas_crea_temas" to "Pressione + para criar um novo tópico",
        "no_temas_encontrados" to "Nenhum tópico encontrado",
        "nombre_tema" to "Nome do tópico",
        "cargando_tema" to "(carregando tópico...)",
        "hilo_no_encontrado" to "Tópico não encontrado",
        "clave_no_disponible" to "(chave não disponível)",
        "clave_tema_no_disponible" to "(chave ou tópico não disponível)",
        "nuevo_hilo" to "Novo thread",
        "titulo_nuevo_hilo" to "Título do thread",
        "tema_no_encontrado" to "Tópico não encontrado",
        "usuario_no_encontrado" to "Usuário não encontrado",
        "eliminar_contacto" to "Excluir contato",
        "bloquear_usuario" to "Bloquear usuário",
        "zona_pruebas" to "Área de testes",
        "debug_textos_realtime" to "Debug: Ir para os testes de textos Realtime",
        "debug_pruebas_supabase" to "Debug: Ir para os testes com Supabase",
        "debug_pruebas_encriptacion" to "Debug: Ir para os testes de criptografia",
        "debug_pruebas_persistencia" to "Debug: Ir para os testes de persistência de dados",
        "admin_zona_reportes" to "ADMIN: Ir para a área de relatórios",
        "bloqueado" to "Bloqueado",
        "introduce_alias_privado_usuario" to "Insira o alias privado do usuário:",
        "crear_nuevo_chat" to "Criar novo chat",
        "selecciona_participantes" to "Selecione participantes:",
        "nombre_del_grupo" to "Nome do grupo",
...
val frances = Idioma(
    palabras = mapOf(
        ...
        "mantener_sesion" to "Rester connecté",
        "recordar_email" to "Se souvenir de l'email",
        "debug_zona_pruebas" to "Debug : Aller à la zone de test",
        "introduce_correo" to "Entrez votre e-mail",
        "correo_restablece_contrasennia" to "Un e-mail a été envoyé pour réinitialiser votre mot de passe. Vérifiez votre boîte de réception.",
        "error_enviando_correo" to "Erreur lors de l'envoi de l'e-mail",
        "info_restablecer_contrasennia" to "Une fois que vous avez réinitialisé votre mot de passe depuis le navigateur, revenez à cette application et connectez-vous avec votre nouveau mot de passe.",
        "formato_correo_invalido" to "Format d'e-mail non valide",
        "error_registrar" to "Erreur lors de l'inscription",
        "correo_aun_no_verificado" to "❗ Votre e-mail n'est pas encore vérifié.",
        "correo_reenviado" to "E-mail renvoyé avec succès",
        "falta_info_correo_reenviado" to "❌ Informations manquantes pour renvoyer l'e-mail",
        "error_reenviar" to "❌ Erreur lors du renvoi.",
        "cargando" to "(chargement...)",
        "imagen" to "Image",
        "enviar_mensaje" to "Envoyer le message",
        "grupo" to "Groupe",
        "item_editar" to "Modifier",
        "item_eliminar" to "Supprimer",
        "participantes_grupo" to "Participants du groupe",
        "editar_mensaje" to "Modifier le message",
        "nuevo_contenido" to "Nouveau contenu",
        "error_leer_mensaje" to "Erreur lors de la lecture du message",
        "crear" to "Créer",
        "tema_creado_correcto" to "Sujet créé avec succès",
        "error_crear_tema" to "Erreur lors de la création du sujet",
        "buscar" to "Rechercher...",
        "nuevo_tema" to "Nouveau sujet",
        "mas_crea_temas" to "Appuyez sur + pour créer un nouveau sujet",
        "no_temas_encontrados" to "Aucun sujet trouvé",
        "nombre_tema" to "Nom du sujet",
        "cargando_tema" to "(chargement du sujet...)",
        "hilo_no_encontrado" to "Fil de discussion introuvable",
        "clave_no_disponible" to "(clé non disponible)",
        "clave_tema_no_disponible" to "(clé ou sujet non disponible)",
        "nuevo_hilo" to "Nouveau fil",
        "titulo_nuevo_hilo" to "Titre du fil",
        "tema_no_encontrado" to "Sujet non trouvé",
        "usuario_no_encontrado" to "Utilisateur non trouvé",
        "eliminar_contacto" to "Supprimer le contact",
        "bloquear_usuario" to "Bloquer l'utilisateur",
        "zona_pruebas" to "Zone de test",
        "debug_textos_realtime" to "Debug : Aller aux tests de textes Realtime",
        "debug_pruebas_supabase" to "Debug : Aller aux tests Supabase",
        "debug_pruebas_encriptacion" to "Debug : Aller aux tests de chiffrement",
        "debug_pruebas_persistencia" to "Debug : Aller aux tests de persistance des données",
        "admin_zona_reportes" to "ADMIN : Aller à la zone de rapports",
        "bloqueado" to "Bloqué",
        "introduce_alias_privado_usuario" to "Entrez l'alias privé de l'utilisateur :",
        "crear_nuevo_chat" to "Créer une nouvelle discussion",
        "selecciona_participantes" to "Sélectionnez les participants :",
        "nombre_del_grupo" to "Nom du groupe",
...
val aleman = Idioma(
    palabras = mapOf(
        ...
        "recordar_email" to "E-Mail merken",
        "debug_zona_pruebas" to "Debug: Zur Testumgebung gehen",
        "introduce_correo" to "Gib deine E-Mail-Adresse ein",
        "correo_restablece_contrasennia" to "Eine E-Mail zum Zurücksetzen Ihres Passworts wurde gesendet. Überprüfen Sie Ihren Posteingang.",
        "error_enviando_correo" to "Fehler beim Senden der E-Mail",
        "info_restablecer_contrasennia" to "Nachdem Sie Ihr Passwort im Browser zurückgesetzt haben, kehren Sie zu dieser App zurück und melden Sie sich mit Ihrem neuen Passwort an.",
        "formato_correo_invalido" to "Ungültiges E-Mail-Format",
        "error_registrar" to "Fehler bei der Registrierung",
        "correo_aun_no_verificado" to "❗ Deine E-Mail ist noch nicht verifiziert.",
        "correo_reenviado" to "E-Mail erfolgreich erneut gesendet",
        "falta_info_correo_reenviado" to "❌ Informationen fehlen, um die E-Mail erneut zu senden",
        "error_reenviar" to "❌ Fehler beim Erneut Senden.",
        "cargando" to "(wird geladen...)",
        "imagen" to "Bild",
        "enviar_mensaje" to "Nachricht senden",
        "grupo" to "Gruppe",
        "item_editar" to "Bearbeiten",
        "item_eliminar" to "Löschen",
        "participantes_grupo" to "Gruppenteilnehmer",
        "editar_mensaje" to "Nachricht bearbeiten",
        "nuevo_contenido" to "Neuer Inhalt",
        "error_leer_mensaje" to "Fehler beim Lesen der Nachricht",
        "crear" to "Erstellen",
        "tema_creado_correcto" to "Thema erfolgreich erstellt",
        "error_crear_tema" to "Fehler beim Erstellen des Themas",
        "buscar" to "Suchen...",
        "nuevo_tema" to "Neues Thema",
        "mas_crea_temas" to "Drücken Sie +, um ein neues Thema zu erstellen",
        "no_temas_encontrados" to "Keine Themen gefunden",
        "nombre_tema" to "Themenname",
        "cargando_tema" to "(Thema wird geladen...)",
        "hilo_no_encontrado" to "Thread nicht gefunden",
        "clave_no_disponible" to "(Schlüssel nicht verfügbar)",
        "clave_tema_no_disponible" to "(Schlüssel oder Thema nicht verfügbar)",
        "nuevo_hilo" to "Neuer Thread",
        "titulo_nuevo_hilo" to "Thread-Titel",
        "tema_no_encontrado" to "Thema nicht gefunden",
        "usuario_no_encontrado" to "Benutzer nicht gefunden",
        "eliminar_contacto" to "Kontakt löschen",
        "bloquear_usuario" to "Benutzer blockieren",
        "zona_pruebas" to "Testbereich",
        "debug_textos_realtime" to "Debug: Zu Realtime-Texttests gehen",
        "debug_pruebas_supabase" to "Debug: Zu Supabase-Tests gehen",
        "debug_pruebas_encriptacion" to "Debug: Zu den Verschlüsselungstests gehen",
        "debug_pruebas_persistencia" to "Debug: Zu den Tests der Datenpersistenz gehen",
        "admin_zona_reportes" to "ADMIN: Zum Berichtebereich gehen",
        "bloqueado" to "Gesperrt",
        "introduce_alias_privado_usuario" to "Geben Sie den privaten Alias des Benutzers ein:",
        "crear_nuevo_chat" to "Neuen Chat erstellen",
        "selecciona_participantes" to "Teilnehmer auswählen:",
        "nombre_del_grupo" to "Gruppenname",
...
val italiano = Idioma(
    palabras = mapOf(
        ...
        "mantener_sesion" to "Rimani connesso",
        "recordar_email" to "Ricorda email",
        "debug_zona_pruebas" to "Debug: Vai all'area di prova",
        "introduce_correo" to "Inserisci la tua email",
        "correo_restablece_contrasennia" to "È stata inviata un'email per reimpostare la tua password. Controlla la tua casella di posta.",
        "error_enviando_correo" to "Errore durante l'invio dell'email",
        "info_restablecer_contrasennia" to "Una volta reimpostata la password dal browser, torna in questa app e accedi con la tua nuova password.",
        "formato_correo_invalido" to "Formato email non valido",
        "error_registrar" to "Errore nella registrazione",
        "correo_aun_no_verificado" to "❗ La tua email non è ancora verificata.",
        "correo_reenviado" to "Email reinviata con successo",
        "falta_info_correo_reenviado" to "❌ Mancano informazioni per rinviare l'email",
        "error_reenviar" to "❌ Errore durante il reinvio.",
        "cargando" to "(caricamento...)",
        "imagen" to "Immagine",
        "enviar_mensaje" to "Invia messaggio",
        "grupo" to "Gruppo",
        "item_editar" to "Modifica",
        "item_eliminar" to "Elimina",
        "participantes_grupo" to "Partecipanti del gruppo",
        "editar_mensaje" to "Modifica messaggio",
        "nuevo_contenido" to "Nuovo contenuto",
        "error_leer_mensaje" to "Errore nella lettura del messaggio",
        "crear" to "Crea",
        "tema_creado_correcto" to "Argomento creato con successo",
        "error_crear_tema" to "Errore nella creazione dell'argomento",
        "buscar" to "Cerca...",
        "nuevo_tema" to "Nuovo argomento",
        "mas_crea_temas" to "Premi + per creare un nuovo argomento",
        "no_temas_encontrados" to "Nessun argomento trovato",
        "nombre_tema" to "Nome dell'argomento",
        "cargando_tema" to "(caricamento argomento...)",
        "hilo_no_encontrado" to "Thread non trovato",
        "clave_no_disponible" to "(chiave non disponibile)",
        "clave_tema_no_disponible" to "(chiave o argomento non disponibile)",
        "nuevo_hilo" to "Nuovo thread",
        "titulo_nuevo_hilo" to "Titolo del thread",
        "tema_no_encontrado" to "Argomento non trovato",
        "usuario_no_encontrado" to "Utente non trovato",
        "eliminar_contacto" to "Elimina contatto",
        "bloquear_usuario" to "Blocca utente",
        "zona_pruebas" to "Area di prova",
        "debug_textos_realtime" to "Debug: Vai ai test dei testi Realtime",
        "debug_pruebas_supabase" to "Debug: Vai ai test con Supabase",
        "debug_pruebas_encriptacion" to "Debug: Vai ai test di crittografia",
        "debug_pruebas_persistencia" to "Debug: Vai ai test di persistenza dei dati",
        "admin_zona_reportes" to "ADMIN: Vai all'area dei report",
        "bloqueado" to "Bloccato",
        "introduce_alias_privado_usuario" to "Inserisci l'alias privato dell'utente:",
        "crear_nuevo_chat" to "Crea nuova chat",
        "selecciona_participantes" to "Seleziona partecipanti:",
        "nombre_del_grupo" to "Nome del gruppo",
